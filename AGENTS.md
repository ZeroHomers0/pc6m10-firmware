...
- 当前构建：`text 62196 / data 0 / bss 2192`。
- 当前 `firmware.bin` SHA-256：`EFD78EEF09C55FC1F73AE9193F16EEB91FB8C0C90B1080343C2D1700BF849634`。
- **2026-09-19 中英文界面**：主设置菜单新增语言选择；2026-09-22 修正为六相第 9 项，保持原厂
  `0..7` 功能范围，不再把仅 12P 使用的电流手动平衡入口暴露给 6P。完整可见文字支持中文/英文；
...
- **2026-09-22 双语代码整理**：数值域固定为列 11..14、单位固定为列 15，删除编辑超时路径的
  重复补单位代码和 6P 不再需要的奇数列汉字渲染器；原厂单位绘制调用保留。维护不变量见
