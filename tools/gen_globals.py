...
MODULES = [
    "01_startup.c", "02_lcd_display.c", "03_input_debounce.c", "04_i2c.c",
    "05_adc.c", "06_param_system.c", "07_state_machine.c", "08_uart3_modbus.c",
    "09_output_stage.c", "10_relay_led.c", "11_auth.c", "12_closed_loop.c",
    "13_gpio_init.c",
]
...
H = ["/* 自动生成：tools/gen_globals.py（目标B 阶段2）。勿手改。",
...
C = ["/* 自动生成：tools/gen_globals.py（目标B 阶段2）。勿手改。 */",
...
open(ROOT + r"\docs\_globals_report.txt", "w", encoding="utf-8").write("\n".join(OUT))
