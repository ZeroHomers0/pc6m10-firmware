...
# 输出: docs/_data_extract.txt (UTF-8)
import struct

BIN = r"D:\code\LPC1765FBD100\LPC1765.bin"
b = open(BIN, "rb").read()
out = []
...
with open(r"D:\code\LPC1765FBD100\decompiled\docs\_data_extract.txt", "w", encoding="utf-8") as f:
    f.write("\n".join(out))
