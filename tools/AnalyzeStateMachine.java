...
public class AnalyzeStateMachine extends GhidraScript {
    ...
    String outDir = "D:/code/LPC1765FBD100/";
    ...
    public void run() throws Exception {
        ...
        PrintWriter flow = new PrintWriter(new FileWriter(outDir + "state_machine_flow.txt"));
        PrintWriter disasm = new PrintWriter(new FileWriter(outDir + "state_machine_disasm.txt"));
