...
public class ListFunctions extends GhidraScript {
    ...
    public void run() throws Exception {
        String outDir = "D:/code/LPC1765FBD100/decompiled/tools/";
        ...
        PrintWriter w = new PrintWriter(new FileWriter(outDir + "_all_functions.txt"));
        ...
        PrintWriter w2 = new PrintWriter(new FileWriter(outDir + "_all_func_symbols.txt"));
