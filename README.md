...
> **当前状态（2026-08-23）**：GCC 工程已可编译，离线差分验证已通过 `output_stage` 144/144、
> `state_machine` 115/115 和既有测试 11/11。下一阶段是断开门极与功率负载的分级 W8 实机验证。
> 文档导航及历史/当前边界见 `DOCUMENTATION_INDEX.md`。
...
- **触发 GPIO**：G1-G6=P0.17/P0.15/P0.18、P2.9/P2.19/P2.16；12 脉波扩展=P2.8/P2.7/P2.6/P2.5、P0.8/P0.7；P0.22=运行继电器 RLY1、P1.22=触发/运行指示。
